...
function moveUp() {
    ...
    const lefttPosition = tank1.style.left.replace(/px/g, "");
    ...
    if (
        ...
        (+currentPosition < 25 ||
            (+currentPosition > 25 &&
                (+lefttPosition < 50 || +lefttPosition > 200)))
    ) {
...
function moveDown() {
    ...
    if (
        +currentPosition < playGround.clientHeight - 80 &&
        (+currentPosition < 25 ||
            (+currentPosition > 25 &&
                (+leftPosition < 50 || +leftPosition > 200)))
    ) {
        tank1.style.top = +currentPosition + 20 + "px";
    } else {
        tank1.classList.add("shakeIt");
...
function moveLeft() {
    ...
    if (
        +currentPosition > 25 &&
        (+topPostition < 50 || +topPostition > 350 || +currentPosition > 220)
    ) {
...
function moveRight() {
    ...
    if (
        ...
        (+topPostition < 50 || +topPostition > 350 || +leftPosition > 200)
    ) {
